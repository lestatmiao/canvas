...
function product_review_show_star(v){
	alert(0);
	for(i=1; i<=5; i++){
		$_('rating_'+i).src='x1.jpg'/*tpa=http://zxygift.com/images/lib/product/x1.jpg*/;
	}
	for(i=1; i<=v; i++){
		$_('rating_'+i).src='x0.jpg'/*tpa=http://zxygift.com/images/lib/product/x0.jpg*/;
	}
}

function rateit_submit(id){
	$_('Rating').value=id;
	$_('RateForm').submit();
}
...
function data_posting(display){
	if(display){
		...
		data_posting.innerHTML='<img src="data_posting.gif"/*tpa=http://zxygift.com/images/lib/global/data_posting.gif*/ width="16" height="16" align="absmiddle" />&nbsp;&nbsp;Processing, please wait...';
